     ...
     // echo "New record created successfully";
						...
						?>
							  ...
							  if($pesan < 1){
							      ...
							      echo "<div class='alert alert-danger alert-dismissible' role='alert'>DATA YANG DIUPLOAD TIDAK BOLEH LEBIH DARI 2 MB </div>";
							  }
							  else {
                                                ...
                                                <td>
                                                    ...
                                                    <?php else : ?>
                                                        ...
                                                        if($status == 3): ?>
                                                            ...
                                                            <div class='alert alert-danger'>Alasan Penolakan : <i>" <?php echo $data['pesan']; ?> "</i>, Mohon diupload ulang...</div>
                                                            <form name="upload" id="upload" method="post" action="?page=paket&action=prosesupload" enctype="multipart/form-data">        
                                                            <input type="hidden" name="idFile" value="<? echo $data['id_file']; ?>">
                                                            <input type="hidden" name="idPaket" value="<? echo $data['id_paket']; ?>">
                                                            <input type="file" name="attachment" id="fileToUpload" onchange="javascript:this.form.submit();">
                                                        ...
                                                        <?php else : 
                                                            ...
                                                            <a href="?page=paket&action=downloaddatadukung&id_file=<?php echo "$data[id_file]" ?>&id_paket=<?php echo "$data[id_paket]" ?>" target="_blank" class="badge badge-primary">Lihat Berkas</a>
