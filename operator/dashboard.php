            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <span class="hidden-xs"><i class="fa fa-user"></i> Operator</span> &nbsp;<i class="fa fa-caret-down"></i>
                </a>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li <?php if (isset($_GET['page']) && $_GET['page'] == 'paket') { echo 'class="active"'; } ?>>
                <a href="?page=paket"><i class="fa fa-newspaper-o"></i> <span>Manajemen Permohonan</span></a>
            </li>
           <hr>
