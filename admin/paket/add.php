    ...
    <div class="col-md-8 col-sm-12">
        <form action="" method="post" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <input class="form-control" name="pagu" type="number" placeholder="Pagu Anggaran" required/>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label">TOTAL HPS</label>
                <div class="col-md-3">
                    <input class="form-control" name="hps" type="number" placeholder="Total Hps" required/>
                </div>
            </div>
            <div class="form-group">
